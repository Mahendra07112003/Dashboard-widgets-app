// // components/AllWidgetsContent.tsx (Content Component)
// 'use client';
...
// export default function AllWidgetsContent() {
...
//     if (widget) {
//       showToast(`Widget '${widget.name}' removed!`, 'success');
//     }
//   };
...
//               <WidgetCard
//                 widget={widget}
//                 onRemove={(widgetId) => handleRemoveWidget(widget.categoryId, widgetId)}
//               />
//               <div className="mt-2">
...
// components/AllWidgetsContent.tsx - Fixed Implementation
// 'use client';
...
//   // Handle the case where categories might have widgetIds instead of widgets
//   const allWidgets = categories.flatMap(category => {
//     // Check if category has widgets or widgetIds property
//     const widgets = (category as any).widgets || [];
...
//     const widget = categories
//       .find(cat => cat.id === categoryId)
//       ?.widgets?.find((w: any) => w.id === widgetId);
    
//     removeWidget(categoryId, widgetId);
    
//     if (widget) {
//       showToast('success', `Widget '${widget.name}' removed!`);
//     }
//   };
...
// components/AllWidgetsContent.tsx - Final Fixed Implementation
'use client';
...
export default function AllWidgetsContent() {
  ...
  //   }));
  // });
  const allWidgets = categories.flatMap((category: Category) => {
    const widgets: Widget[] = category.widgets || [];
  ...
  const handleRemoveWidget = (categoryId: string, widgetId: string) => {
    // Find the widget in the allWidgets array instead of using the categories directly
